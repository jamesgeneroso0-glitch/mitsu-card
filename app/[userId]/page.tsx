...
const themeStyles = {
  indigo: {
    bg: "from-slate-900 via-indigo-950/70 to-slate-900",
    border: "border-indigo-500/30 hover:border-indigo-500/50",
    accent: "text-indigo-400",
    glow: "bg-indigo-600/20",
    avatarGlow: "from-indigo-500 to-blue-500",
    badgeBg: "bg-indigo-500/10 text-indigo-400 border-indigo-500/30",
    btnBg: "bg-indigo-600 hover:bg-indigo-500 shadow-indigo-500/20 active:bg-indigo-700",
  },
  midnight: {
    bg: "from-slate-900 via-purple-950/70 to-slate-900",
    border: "border-purple-500/30 hover:border-purple-500/50",
    accent: "text-purple-400",
    glow: "bg-purple-600/20",
    avatarGlow: "from-purple-500 to-pink-500",
    badgeBg: "bg-purple-500/10 text-purple-400 border-purple-500/30",
    btnBg: "bg-purple-600 hover:bg-purple-500 shadow-purple-500/20 active:bg-purple-700",
  },
  emerald: {
    bg: "from-slate-900 via-emerald-950/70 to-slate-900",
    border: "border-emerald-500/30 hover:border-emerald-500/50",
    accent: "text-emerald-400",
    glow: "bg-emerald-600/20",
    avatarGlow: "from-emerald-500 to-teal-500",
    badgeBg: "bg-emerald-500/10 text-emerald-400 border-emerald-500/30",
    btnBg: "bg-emerald-600 hover:bg-emerald-500 shadow-emerald-500/20 active:bg-emerald-700",
  },
  rose: {
    bg: "from-slate-900 via-rose-950/70 to-slate-900",
    border: "border-rose-500/30 hover:border-rose-500/50",
    accent: "text-rose-400",
    glow: "bg-rose-600/20",
    avatarGlow: "from-rose-500 to-pink-500",
    badgeBg: "bg-rose-500/10 text-rose-400 border-rose-500/30",
    btnBg: "bg-rose-600 hover:bg-rose-500 shadow-rose-500/20 active:bg-rose-700",
  },
  fuchsia: {
    bg: "from-slate-900 via-fuchsia-950/70 to-slate-900",
    ...
    btnBg: "bg-fuchsia-600 hover:bg-fuchsia-500 shadow-fuchsia-500/20 active:bg-fuchsia-700",
  },
  amber: {
    bg: "from-slate-900 via-amber-950/70 to-slate-900",
    border: "border-amber-500/30 hover:border-amber-500/50",
    accent: "text-amber-400",
    glow: "bg-amber-600/20",
    avatarGlow: "from-amber-500 to-orange-500",
    badgeBg: "bg-amber-500/10 text-amber-400 border-amber-500/30",
    btnBg: "bg-amber-600 hover:bg-amber-500 shadow-amber-500/20 active:bg-amber-700",
  },
  cyan: {
    bg: "from-slate-900 via-cyan-950/70 to-slate-900",
    border: "border-cyan-500/30 hover:border-cyan-500/50",
    accent: "text-cyan-400",
    glow: "bg-cyan-600/20",
    avatarGlow: "from-cyan-500 to-blue-500",
    badgeBg: "bg-cyan-500/10 text-cyan-400 border-cyan-500/30",
    btnBg: "bg-cyan-600 hover:bg-cyan-500 shadow-cyan-500/20 active:bg-cyan-700",
  },
  violet: {
    bg: "from-slate-900 via-violet-950/70 to-slate-900",
    ...
    btnBg: "bg-violet-600 hover:bg-violet-500 shadow-violet-500/20 active:bg-violet-700",
  },
  teal: {
    bg: "from-slate-900 via-teal-950/70 to-slate-900",
    border: "border-teal-500/30 hover:border-teal-500/50",
    accent: "text-teal-400",
    glow: "bg-teal-600/20",
    avatarGlow: "from-teal-500 to-emerald-500",
    badgeBg: "bg-teal-500/10 text-teal-400 border-teal-500/30",
    btnBg: "bg-teal-600 hover:bg-teal-500 shadow-teal-500/20 active:bg-teal-700",
  },
  sky: {
    bg: "from-slate-900 via-sky-950/70 to-slate-900",
    border: "border-sky-500/30 hover:border-sky-500/50",
    accent: "text-sky-400",
    glow: "bg-sky-600/20",
    avatarGlow: "from-sky-500 to-indigo-500",
    badgeBg: "bg-sky-500/10 text-sky-400 border-sky-500/30",
    btnBg: "bg-sky-600 hover:bg-sky-500 shadow-sky-500/20 active:bg-sky-700",
  },
  orange: {
    bg: "from-slate-900 via-orange-950/70 to-slate-900",
    border: "border-orange-500/30 hover:border-orange-500/50",
    accent: "text-orange-400",
    glow: "bg-orange-600/20",
    avatarGlow: "from-orange-500 to-amber-500",
    badgeBg: "bg-orange-500/10 text-orange-400 border-orange-500/30",
    btnBg: "bg-orange-600 hover:bg-orange-500 shadow-orange-500/20 active:bg-orange-700",
  },
  lime: {
    bg: "from-slate-900 via-lime-950/70 to-slate-900",
    ...
    btnBg: "bg-lime-600 hover:bg-lime-500 shadow-lime-500/20 active:bg-lime-700",
  },
  blue: {
    bg: "from-slate-900 via-blue-950/70 to-slate-900",
    border: "border-blue-500/30 hover:border-blue-500/50",
    accent: "text-blue-400",
    glow: "bg-blue-600/20",
    avatarGlow: "from-blue-500 to-cyan-500",
    badgeBg: "bg-blue-500/10 text-blue-400 border-blue-500/30",
    btnBg: "bg-blue-600 hover:bg-blue-500 shadow-blue-500/20 active:bg-blue-700",
  },
  sunset: {
    bg: "from-slate-900 via-red-950/70 to-slate-900",
    border: "border-red-500/30 hover:border-red-500/50",
    accent: "text-red-400",
    glow: "bg-red-600/20",
    avatarGlow: "from-red-500 to-rose-500",
    badgeBg: "bg-red-500/10 text-red-400 border-red-500/30",
    btnBg: "bg-red-600 hover:bg-red-500 shadow-red-500/20 active:bg-red-700",
  },
  slate: {
    ...
    btnBg: "bg-slate-700 hover:bg-slate-600 shadow-slate-600/20 active:bg-slate-800",
  },
  obsidian: {
    ...
    btnBg: "bg-zinc-800 hover:bg-zinc-700 shadow-zinc-700/20 border border-zinc-600/50 active:bg-zinc-900",
  },
  aurora: {
    bg: "from-slate-950 via-teal-950/50 to-purple-950/50",
    ...
    btnBg: "bg-gradient-to-r from-teal-600 to-purple-600 hover:from-teal-500 hover:to-purple-500 shadow-teal-500/15 active:opacity-90",
  },
  cyber: {
    bg: "from-slate-950 via-yellow-950/30 to-slate-950",
    ...
    btnBg: "bg-yellow-500 hover:bg-yellow-400 text-slate-950 font-bold shadow-yellow-500/20 active:bg-yellow-600",
  },
  monochrome: {
    ...
    btnBg: "bg-neutral-200 hover:bg-white text-neutral-950 font-bold shadow-neutral-500/15 active:bg-neutral-300",
  },
  coffee: {
    bg: "from-stone-950 via-stone-900 to-stone-950",
    border: "border-amber-700/40 hover:border-amber-600/60",
    accent: "text-amber-200",
    glow: "bg-amber-800/15",
    avatarGlow: "from-amber-600 to-stone-500",
    badgeBg: "bg-amber-900/30 text-amber-200 border-amber-700/40",
    btnBg: "bg-amber-800 hover:bg-amber-700 shadow-amber-900/20 active:bg-amber-900",
  }
};
...
export default async function ClientProfilePage({ params }: Props) {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white flex flex-col items-center justify-center py-8 px-4 relative overflow-x-hidden select-none">
      ...
      {/* Lightweight Ambient Glow (Optimized for Mobile GPUs) */}
      <div className={`absolute w-[280px] h-[280px] ${theme.glow} rounded-full blur-[70px] pointer-events-none transform-gpu`} />
